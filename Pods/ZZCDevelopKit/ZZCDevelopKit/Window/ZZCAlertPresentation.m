...
@interface ZZCAlertPresentation ()
...
@implementation ZZCAlertPresentation
...
- (void)dismissalTransitionDidEnd:(BOOL)completed
{
    if (completed == YES)
    {
        ...
        objc_setAssociatedObject(self.presentingViewController, "presentation_key", nil, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
}
